import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as add_location, k as attr_dev, l as insert_dev, m as append_dev, n as noop, o as create_component, q as query_selector_all, p as claim_component, r as mount_component, F as set_data_dev, u as transition_in, w as transition_out, x as destroy_component } from './client.a18d7000.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t4 = claim_text(h22_nodes, "Inicio");
		...
		h: function hydrate() {
			add_location(h20, file, 3, 4, 84);
			attr_dev(div0, "class", " flex-column ph3 mh1 mv3");
			add_location(div0, file, 2, 2, 41);
			add_location(h21, file, 8, 4, 160);
			attr_dev(div1, "class", "flex-column ph3 mh1 mv3 fr");
			add_location(div1, file, 7, 2, 115);
			add_location(h22, file, 11, 4, 230);
			attr_dev(div2, "class", "flex-column ph3 mh1 mv3 fr");
			add_location(div2, file, 10, 2, 185);
			attr_dev(div3, "class", "ma4 bb inline-flex w-90");

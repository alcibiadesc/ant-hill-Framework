import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as add_location, k as attr_dev, l as insert_dev, m as append_dev, n as noop, o as create_component, q as query_selector_all, p as claim_component, r as mount_component, F as set_data_dev, u as transition_in, w as transition_out, x as destroy_component } from './client.b7c5d71f.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h20, file, 3, 4, 52);
			attr_dev(div0, "class", " ph3 mh1 mv3 fl");
			add_location(div0, file, 2, 2, 18);
			add_location(h21, file, 7, 4, 116);
			attr_dev(div1, "class", " ph3 mh1 mv3 fr");
			add_location(div1, file, 6, 2, 82);
			add_location(h22, file, 11, 4, 178);
			attr_dev(div2, "class", " ph3 mh1 mv3 fr");
			add_location(div2, file, 10, 2, 144);
			add_location(h23, file, 15, 4, 238);
			attr_dev(div3, "class", " ph3 mh1 mv3 fr");
			add_location(div3, file, 14, 2, 204);
			attr_dev(div4, "class", "");

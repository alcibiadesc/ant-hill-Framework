import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, a as space, t as text, c as claim_element, b as children, f as detach_dev, g as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, o as create_component, q as query_selector_all, p as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component } from './client.aef77fbe.js';
import { _ as _1_Title, a as _99_Credits, b as _2_Why } from './2-Why.86a91acd.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img1, file, 32, 6, 722);
			attr_dev(a2, "href", /*pdfVersion*/ ctx[1]);
			attr_dev(a2, "class", "dim svelte-7mn6z7");
			attr_dev(a2, "target", "_blank");
			add_location(a2, file, 31, 4, 666);
			add_location(br1, file, 38, 4, 851);
			add_location(h21, file, 40, 6, 906);
			attr_dev(a3, "href", /*pdfVersion*/ ctx[1]);
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-7mn6z7");
			add_location(a3, file, 39, 4, 862);
			attr_dev(div1, "class", " dib pa2 mh4 tc ");
			add_location(div1, file, 30, 2, 631);

import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, a as space, t as text, c as claim_element, b as children, f as detach_dev, g as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, o as create_component, q as query_selector_all, p as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component } from './client.ed29f9af.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h3, "class", " f2 lh-copy courier mb0");
			add_location(h3, file$2, 40, 4, 785);
			add_location(mark, file$2, 49, 10, 1134);
			add_location(p, file$2, 47, 8, 1082);
			attr_dev(div0, "class", "fl w-100 w-100-m w-90-l f3-l f4-ns ");
			add_location(div0, file$2, 44, 6, 893);
			attr_dev(section, "class", "cf pa3 mt0 pt0 fw3 w-75-l");
			add_location(section, file$2, 42, 4, 842);
			attr_dev(div1, "id", "why");
			add_location(div1, file$2, 39, 2, 766);

import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, z as validate_each_argument, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, k as attr_dev, j as add_location, l as insert_dev, m as append_dev, o as create_component, q as query_selector_all, p as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, A as destroy_each, n as noop } from './client.07cc1edd.js';
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p, "class", "ph3 post-description svelte-1cisw83");
			add_location(p, file, 99, 10, 1964);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file, 105, 10, 2110);
		},
		m: function mount(target, anchor) {
			insert_dev(target, p, anchor);
			append_dev(p, t);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "f3 lh-copy courier mb0 ph3 pt3 underline-hover title-card link svelte-1cisw83");
			add_location(h1, file, 93, 8, 1799);
			attr_dev(div, "class", " center-m post-card w-60-ns w-80-m w-100 shadow-4 br3 svelte-1cisw83");
			add_location(div, file, 91, 6, 1722);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", a_href_value = `/blog/${/*post*/ ctx[3].permalink}`);
			attr_dev(a, "class", "svelte-1cisw83");
			add_location(a, file, 89, 4, 1663);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 86, 2, 1584);
			attr_dev(main, "class", "sections");
			add_location(main, file, 83, 0, 1545);
		},
		m: function mount(target, anchor) {

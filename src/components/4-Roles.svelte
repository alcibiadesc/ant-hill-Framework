...
<div id="roles">
  ...
  <section class="cf pa3 mt0 pt0 fw3 mt0 w-75-l">
    ...
    <div class="fl w-100 w-100-m f3-l f4-ns ">
      ...
      <p>
        Nuestra máxima prioridad, como Key Stakeholder, es entender las
  ...
  <section class="cf pa3 mt0 pt0 fw3 mt0">
    <div class="fl w-100 w-100-m w-75-l f3-l f4-ns ">
      <p>
        El Equipo o Team, es el encargado de materializar soluciones para las
  ...
  <section class="cf pa3 mt0 pt0 fw3 mt0">
    <div class="fl w-100 w-100-m w-75-l f3-l f4-ns ">
      <p>
        La misión del Owner
        <mark>
          es maximizar el valor del producto y la calidad del servicio
          desarrollado por el Team.
        </mark>
      </p>

      <p>
        El Owner debe estar empoderado para establecer los criterios de valor

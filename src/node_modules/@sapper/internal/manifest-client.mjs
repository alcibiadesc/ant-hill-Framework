...
export const components = [
	...
	{
		js: () => import("../../../routes/blog/[permalink].svelte")
	},
	{
		js: () => import("../../../routes/guia.svelte")
	}
];
...
if (typeof window !== 'undefined') {
	import("/Users/alcibiades/Documents/GitHub/ant-hill-Framework/node_modules/sapper/sapper-dev-client.js").then(client => {
